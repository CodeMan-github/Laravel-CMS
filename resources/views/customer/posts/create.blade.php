...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="/customer">{{trans('messages.home')}}</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="/customer">{{trans('messages.posts')}}</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <a href="/customer/posts/create"> {{trans('messages.create_new_post')}} </a>
            </li>
                ...
                <div class="portlet-body form">
                    ...
                    <form action="/customer/posts/create" id="form-username" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select id="render_type" class="form-control" name="render_type">
                                    <option value="{{\App\Posts::RENDER_TYPE_TEXT}}">{{trans('messages.text')}}</option>
                                    <option value="{{\App\Posts::RENDER_TYPE_IMAGE}}">{{trans('messages.image')}}</option>
                                    <option value="{{\App\Posts::RENDER_TYPE_GALLERY}}">{{trans('messages.gallery')}}</option>
                                    <option value="{{\App\Posts::RENDER_TYPE_VIDEO}}">{{trans('messages.video')}}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-offset-3 col-md-8">
                                <label>
                                    <input name="spin" type="checkbox"> Should Spin Text ? </label>
                            </div>
