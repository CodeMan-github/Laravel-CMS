...
@section('extra_js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
			...
			redirect_type = "{{old('redirect_url',$category->redirect_type)}}";
						...
						<div class="form-group" id="redirect_url_div">
                            ...
                            <div class="col-sm-8">
                                <textarea id="redirect_url" class="form-control" name="redirect_url"
                                          placeholder="{{trans('messages.enter_redirect_url')}}">{{old('redirect_url',$category->redirect_url)}}</textarea>
                            </div>
                        </div>
						<div class="form-group" id="splash_page_content_div">
                            ...
                            <div class="col-sm-8">
                                <textarea id="splash_page_content" class="form-control" name="splash_page_content"
                                          placeholder="{{trans('messages.enter_splash_page_content')}}">{{old('splash_page_content',$category->splash_page_content)}}</textarea>
                            </div>
                        </div>
