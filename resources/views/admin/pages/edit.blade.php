...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="/admin/pages/edit/{{$page->id}}">{{trans('messages.edit')}} - {{$page->title}}</a>
            </li>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box green-meadow">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-docs"></i>{{trans('messages.edit')}} - {{$page->title}}
                    </div>
                    <div class="tools">
                    ...
                    <form action="/admin/pages/update" id="form-username" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="title" class="form-control" type="text" name="title"
                                       placeholder="{{trans('messages.enter_title')}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-offset-3 col-md-4">
                                <label>
                                    <input {{$page->show_in_sidebar == 1?'checked':''}} name="show_in_sidebar"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-offset-3 col-md-4">
                                <label>
                                    <input {{$page->show_in_footer == 1?'checked':''}} name="show_in_footer"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="description" class="form-control" name="description"
                                          placeholder="{{trans('messages.enter_description')}}">{{old('description',$page->description)}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="seo_keywords" class="form-control" name="seo_keywords"
                                          placeholder="{{trans('messages.enter_seo_keywords')}}">{{old('seo_keywords',$page->seo_keywords)}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="seo_description" class="form-control" name="seo_description"
                                          placeholder="{{trans('messages.enter_seo_description')}}">{{old('seo_description',$page->seo_description)}}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <select id="author" class="form-control" name="author">
                                    @foreach($admins as $admin)
                                        <option {{$page->author_id == $admin->id ? 'selected':''}} value="{{$admin->id}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select id="status" class="form-control" name="status">
                                    <option {{$page->status == \App\Posts::STATUS_PUBLISHED?'selected':''}}
                                            value="{{\App\Posts::STATUS_PUBLISHED}}">{{trans('messages.published')}}
                                    </option>
                                    <option {{$page->status == \App\Posts::STATUS_HIDDEN?'selected':''}}
