        ...
        <div class="col-md-12">
            <div class="portlet box green-meadow">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-puzzle"></i>All Lists
                    </div>
                    <div class="actions">
                        <a href="/admin/lists/create" class="btn red">
                    ...
                    <table class="table table-striped table-bordered table-hover"  >
                        ...
                        @foreach($posts as $post)
                            <tr>
                                ...
                                <td><a href="/admin/lists/edit/{{$post->id}}"
                                       class="btn btn-warning btn-sm">{{trans('messages.edit')}}</a>
                                </td>
                                <td><a data-href="/admin/lists/delete/{{$post->id}}" data-toggle="modal"
