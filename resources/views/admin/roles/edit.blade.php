...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="/admin/roles/create">{{trans('messages.edit')}} - {{$role->role}}</a>
            </li>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box green-meadow">
                ...
                <div class="portlet-body form">
                    ...
                    <form action="/admin/roles/update" id="form-username" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="role" name="role" class="form-control" value="{{old('role',$role->name)}}"/>
                            </div>
                        </div>
                                    ...
                                    @foreach($permissions_groups as $group)
                                        <optgroup label="{{$group['name']}}">
                                            @foreach($group['permissions'] as $permission)
                                                <option {{in_array($permission['key'],$parsed_permissions) ? 'selected':''}} value="{{$permission['key']}}">{{$permission['value']}}</option>
                                            @endforeach
                                        </optgroup>
                                    @endforeach
                                </select>
