...
<head>
    <meta charset="utf-8">
    <title>RSS Auto Pilot - Installer</title>
                ...
                <div class="panel-body">
                    ...
                    <p>
                        <a href="/install/requirements.php?<?php echo(time()); ?>" class="btn btn-success btn-lg"
                           role="button">Install</a> <strong>OR</strong>
                        <a href="/install/upgrade/requirements.php" class="btn btn-info btn-lg"
